            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: const DecorationImage(
                  image: NetworkImage('https://raw.githubusercontent.com/DeLaRosaRojas/IAMoviles-Act-13-navegaci-n-entre-6-pantallas/refs/heads/main/bannerhogar.png'), 
                  fit: BoxFit.cover, 
                  colorFilter: ColorFilter.mode(Colors.black45, BlendMode.darken)
                ),
              ),
              child: const Center(child: Text("HOGAR", style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold))),
            ),
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: 20),
              child: Text("Decoración y Blancos", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            ),
            const Divider(thickness: 3, color: Color(0xFFD4AF37), indent: 20, endIndent: 200),
            
            _cardProducto("Cortina Blackout", "450.00", 'https://raw.githubusercontent.com/DeLaRosaRojas/IAMoviles-Act-13-navegaci-n-entre-6-pantallas/refs/heads/main/hogar1.png'),
            _cardProducto("Cojín Decorativo", "180.00", 'https://raw.githubusercontent.com/DeLaRosaRojas/IAMoviles-Act-13-navegaci-n-entre-6-pantallas/refs/heads/main/hogar2.png'),
