            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: const DecorationImage(
                  image: NetworkImage('https://raw.githubusercontent.com/DeLaRosaRojas/IAMoviles-Act-13-navegaci-n-entre-6-pantallas/refs/heads/main/bannermaq.png'), 
                  fit: BoxFit.cover, 
                  colorFilter: ColorFilter.mode(Colors.black45, BlendMode.darken)
                ),
              ),
              child: const Center(child: Text("MÁQUINAS", style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold))),
            ),
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: 20),
              child: Text("Equipos de Costura", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            ),
            const Divider(thickness: 3, color: Color(0xFFD4AF37), indent: 20, endIndent: 200),
            
            _cardProducto("Máquina Singer Pro", "3,500.00", 'https://raw.githubusercontent.com/DeLaRosaRojas/IAMoviles-Act-13-navegaci-n-entre-6-pantallas/refs/heads/main/maquina1.png'),
            _cardProducto("Overlock Industrial", "4,200.00", 'https://raw.githubusercontent.com/DeLaRosaRojas/IAMoviles-Act-13-navegaci-n-entre-6-pantallas/refs/heads/main/maquina2.png'),
